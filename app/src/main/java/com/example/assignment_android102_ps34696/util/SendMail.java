package com.example.assignment_android102_ps34696.util;
...
public class SendMail {
    private final String username = "sadtps34696@fpt.edu.vn";
    private final String password = "djqecgcuaqcdubyf";
